...
import { StepComponentProps } from '../../types/meets';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            <div className="text-2xl font-bold text-white">
              {formatCurrency(data.registrationFee || 0)}
            </div>
            <div className="text-sm text-slate-400">Standard Registration</div>
          </div>
          
          {data.earlyBirdDeadline && (
            <div className="text-center">
              <div className="text-2xl font-bold text-green-400">
                {formatCurrency(data.earlyBirdFee || 0)}
              </div>
              <div className="text-sm text-slate-400">Early Bird Special</div>
              <div className="text-xs text-green-400 mt-1">
                Save {formatCurrency((data.registrationFee || 0) - (data.earlyBirdFee || 0))}
              </div>
            </div>
          )}
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-slate-400">Max Participants</div>
            <div className="text-xs text-slate-400 mt-1">
              Estimated Revenue: {formatCurrency((data.registrationFee || 0) * (data.maxParticipants || 0))}
            </div>
          </div>
        </div>
      </div>
