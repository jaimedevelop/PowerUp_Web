...
import { getMeetById } from '../../../firebase/database';
import { Meet } from '../../types/meets';

interface MeetDashboardProps {}

const MeetDashboard: React.FC<MeetDashboardProps> = () => {
              ...
              <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-white">${meet.revenue || 0}</p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-white">
                      {Math.ceil((meet.date.toDate() - new Date()) / (1000 * 60 * 60 * 24))}
                    </p>
