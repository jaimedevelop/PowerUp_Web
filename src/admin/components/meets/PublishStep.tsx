...
import { StepComponentProps, MeetStatus } from '../../types/meets';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-purple-900/50 to-blue-900/50 p-6 rounded-lg border border-purple-500/30">
        <h3 className="text-white font-bold mb-4">Revenue Projection</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-white">
              {formatCurrency(data.registrationFee * data.maxParticipants)}
            </div>
            <div className="text-sm text-slate-300">Maximum Revenue</div>
            <div className="text-xs text-slate-400">
              {data.maxParticipants} × {formatCurrency(data.registrationFee)}
            </div>
          </div>
          
          <div className="text-center">
            <div className="text-2xl font-bold text-green-400">
              {formatCurrency(data.registrationFee * Math.floor(data.maxParticipants * 0.8))}
            </div>
            <div className="text-sm text-slate-300">Conservative Estimate</div>
            <div className="text-xs text-slate-400">80% capacity</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-slate-300">Total Capacity</div>
            <div className="text-xs text-slate-400">Maximum athletes</div>
          </div>
        </div>
      </div>
